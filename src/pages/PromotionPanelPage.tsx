...
const PromotionPanelPage = () => {
  ...
  const handleAction = async (id: string, action: string) => {
    ...
    switch (action) {
      case "promote": {
        ...
        // Log history before promoting
        if (schoolId) {
          await logStudentHistory(id, schoolId, student.standard, student.section);
        }
        if (nextClass) {
  ...
  const handleBulkPromote = async () => {
    ...
    for (const s of targets) {
      // Log history for each student before promotion
      if (schoolId) {
        await logStudentHistory(s.id, schoolId, s.standard, s.section);
      }
      if (nextClass) {
    ...
    <div className="space-y-4 px-4 pb-10 relative z-10 py-6">
      ...
      <div className="bg-black/20 backdrop-blur-md border border-primary/30 rounded-2xl p-4 sm:p-6 max-w-4xl mx-auto space-y-4 shadow-[0_0_30px_hsl(51,100%,50%,0.08)]">
        ...
        <Button
          ...
          disabled={isBulkPromoting || !bulkFromClass}
          className="w-full bg-black/60 hover:bg-black/80 text-foreground font-bold py-3 rounded-lg border border-primary/40 shadow-[0_0_12px_hsl(51,100%,50%,0.1)]"
        >
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <Button
                          ...
                          className="w-full bg-black/60 hover:bg-black/80 text-foreground font-bold py-2 rounded-lg border border-primary/40 text-sm shadow-[0_0_10px_hsl(51,100%,50%,0.1)] hover:shadow-[0_0_15px_hsl(51,100%,50%,0.2)]"
                        >
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          <Button
                            ...
                            disabled={!prevClass}
                            className="w-full bg-black/60 hover:bg-black/80 text-foreground font-bold py-2 rounded-lg border border-primary/40 text-sm disabled:opacity-40 shadow-[0_0_8px_hsl(51,100%,50%,0.08)]"
                          >
                          ...
                          <Button
                            ...
                            className="w-full bg-black/60 hover:bg-black/80 text-foreground font-bold py-2 rounded-lg border border-primary/40 text-sm shadow-[0_0_8px_hsl(51,100%,50%,0.08)]"
                          >
                          ...
                          <Button
                            ...
                            className="w-full bg-destructive hover:bg-destructive/80 text-destructive-foreground font-bold py-2 rounded-lg border border-red-500/50 text-sm shadow-[0_0_10px_hsl(0,84%,60%,0.2)]"
                          >
